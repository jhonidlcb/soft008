...
export default function BillingInformation() {
  ...
  const { data: billingInfo, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (data && !selectedCountry) {
        setSelectedCountry(data.country || 'Paraguay');
        setSelectedDepartment(data.department || '');
      } else if (!data && !selectedCountry) {
        setSelectedCountry('Paraguay');
      }
      return data;
    },
  });
  ...
  useEffect(() => {
    if (isEditing && billingInfo) {
      setSelectedCountry(billingInfo.country || 'Paraguay');
      setSelectedDepartment(billingInfo.department || '');
    }
