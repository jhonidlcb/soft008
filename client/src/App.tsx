...
import SistemaTurnosItapua from "./pages/SistemaTurnosItapua";
import PrivacyPolicy from "./pages/PrivacyPolicy";
import CookiePolicy from "./pages/CookiePolicy";
import DigitalizacionNegociosItapua from "./pages/DigitalizacionNegociosItapua";
import FacturacionElectronicaSifen from "./pages/FacturacionElectronicaSifen";
import SoftwareConsultoriosItapua from "./pages/SoftwareConsultoriosItapua";
import DesarrolloWebItapua from "./pages/DesarrolloWebItapua";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/sistema-de-turnos-en-itapua" component={SistemaTurnosItapua} />
      <Route path="/privacidad" component={PrivacyPolicy} />
      <Route path="/cookies" component={CookiePolicy} />
      <Route path="/digitalizacion-de-negocios-en-itapua" component={DigitalizacionNegociosItapua} />
      <Route path="/facturacion-electronica-sifen-itapua" component={FacturacionElectronicaSifen} />
      <Route path="/software-para-consultorios-en-itapua" component={SoftwareConsultoriosItapua} />
      <Route path="/desarrollo-web-en-itapua" component={DesarrolloWebItapua} />
